...
const app = Vue.createApp({
    data() {
        return {
            ...
            iconColors: ["blue", "green", "red", "yellow", "orange", "cyan", "purple"],
    ...
    methods: {
        ...
        guessColor() {
            ...
            if (colorExists) {
                if (guess.toUpperCase() == data.color.toUpperCase()) {
                    ...
                    if (this.playableIcons.length > this.currentIconToVerify + 1) {
                        ...
                        setTimeout(() => {
                            ...
                            setTimeout(() => {
                                post('http://erp_colorhack/finished', JSON.stringify({result: true}));
        ...
        failHack() {
            ...
            this.stage = 4;
            post('http://erp_colorhack/finished', JSON.stringify({result: false}));
